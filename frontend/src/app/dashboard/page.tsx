              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border-2 border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8B7355] text-black"
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    <input
                      ...
                      onChange={handleInputChange}
                      required
                      className="flex-1 px-4 py-3 border-2 border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8B7355] text-black"
                    ...
                    <button
                      ...
                      className="bg-black border-2 border-black shadow-[4px_4px_0_0_rgba(0,0,0,1)] px-4 py-3 rounded-lg hover:shadow-[2px_2px_0_0_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-200 flex items-center gap-2 text-white font-bold"
                    >
